...
const BacklogHeader = ({ onTabChange, onLogout }) => {

    return (
        <div className='flex flex-row items-center'>
            <div className='w-52 min-h-screen bg-C6DFDF flex flex-col text-center'>
                <ul className='py-6'>
                    <li className='mb-10'>
                    ...
                    <li>
                        <hr className='my-2 border-t border-white' />
                        <h3 className='text-lg font-semibold text-white' onClick={onLogout}>Se déconnecter</h3>
                        <hr className='my-2 border-t border-white' />
                    </li>
                </ul>
            </div>
